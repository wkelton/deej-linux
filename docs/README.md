...
> **_New:_** [work-in-progress deej FAQ](./faq/faq.md)!
...
It is still _very much a work-in-progress_, but I'm happy to [share it in its current state](./faq/faq.md) in hopes that it at least covers some questions you might have.
...
Please see [`docs/CONTRIBUTING.md`](./CONTRIBUTING.md).
